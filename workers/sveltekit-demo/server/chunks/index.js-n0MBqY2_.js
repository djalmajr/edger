import { o as options, g as get_hooks, r as read_implementation, s as set_read_implementation } from './chunks/internal.js-BnBZCXp-.js';
import { n as noop, T as TRAILING_SLASH_PARAM, I as INVALIDATED_PARAM, R as Redirect, S as SvelteKitError, g as get_status, t as text_encoder, o as once, H as HttpError, b as normalize_error, d as create_remote_key, p as parse_remote_arg, s as stringify, A as ActionFailure, e as split_remote_key, f as base64_encode } from './chunks/shared.js-B7gP25eT.js';
import { s as set_private_env, a as set_public_env, b as base, p as public_env, c as assets, r as reset, d as app_dir } from './chunks/internal2.js-DTokQbBy.js';
import { f as format_server_error, j as json, i as is_form_content_type, t as text, h as has_prerendered_path, a as handle_fatal_error, r as redirect_response, g as get_set_cookies, n as negotiate, w as with_request_store, p as parseString, s, m as merge_tracing, b as method_not_allowed, c as static_error_page, d as handle_error_and_jsonify, e as get_global_name, k as create_replacer, l as serialize_uses, o as clarify_devalue_error, E as ENDPOINT_METHODS, P as PAGE_METHODS, q as get_node_type, u as isRedirect, v as escape_html, x as error, y as deserialize_binary_form } from './chunks/utils.js-CSEycWRK.js';
...
import { R as uneval, V as writable, W as readable, U as stringify$1 } from './chunks/server.js-DbjiTjSX.js';
...
function generate_route_object(route, url, client) {
	...
	const nodes = [
		...
		...layouts.map((l) => l?.[1]),
		leaf[1]
	].filter((n) => typeof n === "number").map((n) => `'${n}': () => ${create_client_import(client.nodes?.[n])}`).join(",\n		");
...
function create_css_import(route, url, client) {
	...
	if (!css) return "";
	return `${create_client_import(client.start)}.then(x => x.load_css([${css}]));`;
}
//#endregion
...
export { Server as S };
//# sourceMappingURL=index.js-n0MBqY2_.js.map
