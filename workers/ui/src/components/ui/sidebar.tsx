...
import { useIsMobile } from "@edger/ui/hooks/use-mobile";
...
import { PanelLeftIcon } from "@edger/ui/icons/lucide";
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0: sem isso o flex-1 não encolhe abaixo do conteúdo (tabelas
        // largas empurram a página inteira em vez de rolar no próprio container)
