...
import { Slot as SlotPrimitive } from "@edger/ui/components/ui/slot";
import * as React from "react";
import * as ReactDOM from "react-dom";
import { useComposedRefs } from "@edger/ui/lib/compose-refs";
...
function Sortable<T>(props: SortableProps<T>) {
  const {
    ...
    onDragCancel: propsOnDragCancel,
    ...sortableProps
  } = props;
  ...
  const onDragEnd = React.useCallback(
    ...
    [value, onValueChange, onMove, getItemValue, propsOnDragEnd],
  );

  const onDragCancel = React.useCallback(
    (event: DragEndEvent) => {
      propsOnDragCancel?.(event);
