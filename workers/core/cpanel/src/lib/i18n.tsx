...
const messages = {
  "pt-BR": {
    ...
    "account.role": "Perfil",
    "nav.keys": "API Keys",
    "nav.keys.description": "Chaves escopadas do control plane",
  ...
  "en-US": {
    ...
    "account.role": "Role",
    "nav.keys": "API Keys",
    "nav.keys.description": "Scoped control-plane keys",
  ...
  "es-ES": {
    ...
    "account.role": "Perfil",
    "nav.keys": "API Keys",
    "nav.keys.description": "Claves del control plane con permisos",
