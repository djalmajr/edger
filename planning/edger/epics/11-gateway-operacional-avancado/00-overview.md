...
- SSE/historico operacional e mutacoes dinamicas ainda nao foram fechados.
...
in-progress (2026-07-01) - Story 11.01 entregou proxy HTTP loopback-only em
...
11.04 entregou vhosts/host routing local via `hosts` no manifesto, com reserved
paths protegidos e prova por header `Host`. SSE/historico operacional e
mutacoes dinamicas continuam como stories dedicadas.
