...
|---|---|---|---|---|---|
| 10.01 Inventario operacional | `01-inventario-operacional-de-modulos.md` | Definir e expor inventario de modulos/extensoes com capabilities e diagnostics | medium | planned | Epic 06, Epic 08.13 |
